...
public class WeatherReport implements org.apache.thrift.TBase<WeatherReport, WeatherReport._Fields>, java.io.Serializable, Cloneable, Comparable<WeatherReport> {
  ...
  public WeatherReport setDateTime(@org.apache.thrift.annotation.Nullable String dateTime) {
    this.dateTime = dateTime;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case ATMOSPHERICPRESSURE:
      if (value == null) {
        ...
        setAtmosphericpressure((Short)value);
      }
      break;
  ...
  public int compareTo(WeatherReport other) {
    ...
    lastComparison = Boolean.valueOf(isSetWindStrength()).compareTo(other.isSetWindStrength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetRainfall()).compareTo(other.isSetRainfall());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRainfall()) {
    ...
    lastComparison = Boolean.valueOf(isSetAtmosphericpressure()).compareTo(other.isSetAtmosphericpressure());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetWindDirection()).compareTo(other.isSetWindDirection());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WeatherReport(");
    boolean first = true;
