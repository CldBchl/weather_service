...
public class Weather {
  ...
  public interface Iface {
    ...
    public WeatherReport receiveForecastFor(long userId, String time) throws UnknownUserException, DateException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void login(Location location, org.apache.thrift.async.AsyncMethodCallback<Long> resultHandler) throws org.apache.thrift.TException;

    public void logout(long sessionToken, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException;

    public void sendWeatherReport(WeatherReport report, long sessionToken, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException;

    public void receiveForecastFor(long userId, String time, org.apache.thrift.async.AsyncMethodCallback<WeatherReport> resultHandler) throws org.apache.thrift.TException;
    ...
    public void sendWarning(SystemWarning systemWarning, long userId, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_receiveForecastFor(long userId, String time) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class login_call extends org.apache.thrift.async.TAsyncMethodCall<Long> {
      private Location location;
      public login_call(Location location, org.apache.thrift.async.AsyncMethodCallback<Long> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public Long getResult() throws LocationException, org.apache.thrift.TException {
    ...
    public static class logout_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      ...
      public logout_call(long sessionToken, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public Boolean getResult() throws UnknownUserException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class sendWeatherReport_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      private WeatherReport report;
      private long sessionToken;
      public sendWeatherReport_call(WeatherReport report, long sessionToken, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.report = report;
        this.sessionToken = sessionToken;
      }
      ...
      public Boolean getResult() throws UnknownUserException, ReportException, DateException, LocationException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class receiveForecastFor_call extends org.apache.thrift.async.TAsyncMethodCall<WeatherReport> {
      private long userId;
      private String time;
      public receiveForecastFor_call(long userId, String time, org.apache.thrift.async.AsyncMethodCallback<WeatherReport> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.time = time;
      }
    ...
    public static class sendWarning_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      private SystemWarning systemWarning;
      private long userId;
      public sendWarning_call(SystemWarning systemWarning, long userId, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class login<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, login_args, Long> {
      ...
      public void start(I iface, login_args args, org.apache.thrift.async.AsyncMethodCallback<Long> resultHandler) throws org.apache.thrift.TException {
    ...
    public static class sendWeatherReport<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendWeatherReport_args, Boolean> {
      public sendWeatherReport() {
        super("sendWeatherReport");
      }
      ...
      public void start(I iface, sendWeatherReport_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException {
    ...
    public static class sendWarning<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendWarning_args, Boolean> {
      public sendWarning() {
        super("sendWarning");
      }
      ...
      public void start(I iface, sendWarning_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class login_result implements org.apache.thrift.TBase<login_result, login_result._Fields>, java.io.Serializable, Cloneable, Comparable<login_result>   {
    ...
    public int compareTo(login_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetLocationException()).compareTo(other.isSetLocationException());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLocationException()) {
  ...
  public static class logout_result implements org.apache.thrift.TBase<logout_result, logout_result._Fields>, java.io.Serializable, Cloneable, Comparable<logout_result>   {
    ...
    public int compareTo(logout_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetUnknownUserException()).compareTo(other.isSetUnknownUserException());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUnknownUserException()) {
  ...
  public static class sendWeatherReport_args implements org.apache.thrift.TBase<sendWeatherReport_args, sendWeatherReport_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendWeatherReport_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendWeatherReport_args(");
      boolean first = true;
  ...
  public static class sendWeatherReport_result implements org.apache.thrift.TBase<sendWeatherReport_result, sendWeatherReport_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendWeatherReport_result>   {
    ...
    public int compareTo(sendWeatherReport_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetReportException()).compareTo(other.isSetReportException());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetReportException()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendWeatherReport_result(");
      boolean first = true;
  ...
  public static class receiveForecastFor_args implements org.apache.thrift.TBase<receiveForecastFor_args, receiveForecastFor_args._Fields>, java.io.Serializable, Cloneable, Comparable<receiveForecastFor_args>   {
    ...
    public receiveForecastFor_args setTime(@org.apache.thrift.annotation.Nullable String time) {
      this.time = time;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("receiveForecastFor_args(");
      boolean first = true;
  ...
  public static class receiveForecastFor_result implements org.apache.thrift.TBase<receiveForecastFor_result, receiveForecastFor_result._Fields>, java.io.Serializable, Cloneable, Comparable<receiveForecastFor_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("receiveForecastFor_result(");
      boolean first = true;
  ...
  public static class checkWeatherWarnings_args implements org.apache.thrift.TBase<checkWeatherWarnings_args, checkWeatherWarnings_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkWeatherWarnings_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("checkWeatherWarnings_args(");
      boolean first = true;
  ...
  public static class checkWeatherWarnings_result implements org.apache.thrift.TBase<checkWeatherWarnings_result, checkWeatherWarnings_result._Fields>, java.io.Serializable, Cloneable, Comparable<checkWeatherWarnings_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("checkWeatherWarnings_result(");
      boolean first = true;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.success = WeatherWarning.findByValue(iprot.readI32());
                struct.setSuccessIsSet(true);
              } else {
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
  ...
  public static class sendWarning_args implements org.apache.thrift.TBase<sendWarning_args, sendWarning_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendWarning_args>   {
    ...
    public int compareTo(sendWarning_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetSystemWarning()).compareTo(other.isSetSystemWarning());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSystemWarning()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendWarning_args(");
      boolean first = true;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, sendWarning_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // SYSTEM_WARNING
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.systemWarning = SystemWarning.findByValue(iprot.readI32());
  ...
  public static class sendWarning_result implements org.apache.thrift.TBase<sendWarning_result, sendWarning_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendWarning_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendWarning_result(");
      boolean first = true;
