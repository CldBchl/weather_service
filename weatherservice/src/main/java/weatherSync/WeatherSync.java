...
public class WeatherSync {
  ...
  public interface Iface {
    ...
    public boolean syncWeatherReport(SystemWarning systemWarning, long userId) throws UnknownUserException, org.apache.thrift.TException;

    public boolean syncSystemWarning(WeatherReport weatherReport, long userId) throws UnknownUserException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void syncWeatherReport(SystemWarning systemWarning, long userId, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;

    public void syncSystemWarning(WeatherReport weatherReport, long userId, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean syncWeatherReport(SystemWarning systemWarning, long userId) throws UnknownUserException, org.apache.thrift.TException
    {
      send_syncWeatherReport(systemWarning, userId);
      return recv_syncWeatherReport();
    }

    public void send_syncWeatherReport(SystemWarning systemWarning, long userId) throws org.apache.thrift.TException
    {
    ...
    public boolean syncSystemWarning(WeatherReport weatherReport, long userId) throws UnknownUserException, org.apache.thrift.TException
    {
      send_syncSystemWarning(weatherReport, userId);
      return recv_syncSystemWarning();
    }

    public void send_syncSystemWarning(WeatherReport weatherReport, long userId) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void syncWeatherReport(SystemWarning systemWarning, long userId, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      syncWeatherReport_call method_call = new syncWeatherReport_call(systemWarning, userId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class syncWeatherReport_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Boolean> {
      ...
      private long userId;
      public syncWeatherReport_call(SystemWarning systemWarning, long userId, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public void syncSystemWarning(WeatherReport weatherReport, long userId, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      syncSystemWarning_call method_call = new syncSystemWarning_call(weatherReport, userId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class syncSystemWarning_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Boolean> {
      ...
      private long userId;
      public syncSystemWarning_call(WeatherReport weatherReport, long userId, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class syncWeatherReport<I extends Iface> extends org.apache.thrift.ProcessFunction<I, syncWeatherReport_args> {
      ...
      public syncWeatherReport_result getResult(I iface, syncWeatherReport_args args) throws org.apache.thrift.TException {
        syncWeatherReport_result result = new syncWeatherReport_result();
        try {
          result.success = iface.syncWeatherReport(args.systemWarning, args.userId);
          result.setSuccessIsSet(true);
        } catch (UnknownUserException unknownUserException) {
          result.unknownUserException = unknownUserException;
        }
    ...
    public static class syncSystemWarning<I extends Iface> extends org.apache.thrift.ProcessFunction<I, syncSystemWarning_args> {
      ...
      public syncSystemWarning_result getResult(I iface, syncSystemWarning_args args) throws org.apache.thrift.TException {
        syncSystemWarning_result result = new syncSystemWarning_result();
        try {
          result.success = iface.syncSystemWarning(args.weatherReport, args.userId);
          result.setSuccessIsSet(true);
        } catch (UnknownUserException unknownUserException) {
          result.unknownUserException = unknownUserException;
        }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class syncWeatherReport<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, syncWeatherReport_args, java.lang.Boolean> {
      ...
      public void start(I iface, syncWeatherReport_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.syncWeatherReport(args.systemWarning, args.userId,resultHandler);
      }
    }
    ...
    public static class syncSystemWarning<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, syncSystemWarning_args, java.lang.Boolean> {
      ...
      public void start(I iface, syncSystemWarning_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.syncSystemWarning(args.weatherReport, args.userId,resultHandler);
      }
    }
  ...
  public static class syncWeatherReport_args implements org.apache.thrift.TBase<syncWeatherReport_args, syncWeatherReport_args._Fields>, java.io.Serializable, Cloneable, Comparable<syncWeatherReport_args>   {
     ...
     * @see SystemWarning
     */
    public syncWeatherReport_args setSystemWarning(@org.apache.thrift.annotation.Nullable SystemWarning systemWarning) {
      this.systemWarning = systemWarning;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 1: // SYSTEM_WARNING
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.systemWarning = weatherSync.SystemWarning.findByValue(iprot.readI32());
  ...
  public static class syncSystemWarning_args implements org.apache.thrift.TBase<syncSystemWarning_args, syncSystemWarning_args._Fields>, java.io.Serializable, Cloneable, Comparable<syncSystemWarning_args>   {
    ...
    public syncSystemWarning_args setWeatherReport(@org.apache.thrift.annotation.Nullable WeatherReport weatherReport) {
      this.weatherReport = weatherReport;
      return this;
    }
